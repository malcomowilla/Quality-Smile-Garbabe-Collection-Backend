...
class EmailSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_setting" do
    assert_difference("EmailSetting.count") do
      post email_settings_url, params: { email_setting: { api_key: @email_setting.api_key, sender_email: @email_setting.sender_email, smtp_host: @email_setting.smtp_host, smtp_password: @email_setting.smtp_password, smtp_username: @email_setting.smtp_username } }
    end
  ...
  test "should update email_setting" do
    patch email_setting_url(@email_setting), params: { email_setting: { api_key: @email_setting.api_key, sender_email: @email_setting.sender_email, smtp_host: @email_setting.smtp_host, smtp_password: @email_setting.smtp_password, smtp_username: @email_setting.smtp_username } }
