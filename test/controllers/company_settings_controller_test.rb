...
class CompanySettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create company_setting" do
    assert_difference("CompanySetting.count") do
      post company_settings_url, params: { company_setting: { company_name: @company_setting.company_name, contact_info: @company_setting.contact_info, email_info: @company_setting.email_info } }
    end
  ...
  test "should update company_setting" do
    patch company_setting_url(@company_setting), params: { company_setting: { company_name: @company_setting.company_name, contact_info: @company_setting.contact_info, email_info: @company_setting.email_info } }
