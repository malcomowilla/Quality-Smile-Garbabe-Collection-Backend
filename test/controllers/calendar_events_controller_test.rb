...
class CalendarEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar_event" do
    assert_difference("CalendarEvent.count") do
      post calendar_events_url, params: { calendar_event: { end_date_time: @calendar_event.end_date_time, event_title: @calendar_event.event_title, start_date_time: @calendar_event.start_date_time } }
    end
  ...
  test "should update calendar_event" do
    patch calendar_event_url(@calendar_event), params: { calendar_event: { end_date_time: @calendar_event.end_date_time, event_title: @calendar_event.event_title, start_date_time: @calendar_event.start_date_time } }
