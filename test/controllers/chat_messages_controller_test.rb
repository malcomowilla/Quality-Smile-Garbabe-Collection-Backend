...
class ChatMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_message" do
    assert_difference("ChatMessage.count") do
      post chat_messages_url, params: { chat_message: { admin_id: @chat_message.admin_id, content: @chat_message.content, date_time_of_message: @chat_message.date_time_of_message } }
    end
  ...
  test "should update chat_message" do
    patch chat_message_url(@chat_message), params: { chat_message: { admin_id: @chat_message.admin_id, content: @chat_message.content, date_time_of_message: @chat_message.date_time_of_message } }
