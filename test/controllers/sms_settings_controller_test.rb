...
class SmsSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sms_setting" do
    assert_difference("SmsSetting.count") do
      post sms_settings_url, params: { sms_setting: { api_key: @sms_setting.api_key, api_secret: @sms_setting.api_secret } }
    end
  ...
  test "should update sms_setting" do
    patch sms_setting_url(@sms_setting), params: { sms_setting: { api_key: @sms_setting.api_key, api_secret: @sms_setting.api_secret } }
